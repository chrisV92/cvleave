...
<span style="display:inline-flex;align-items:center;gap:9px;">
    <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
        ...
        <defs>
            <linearGradient id="cvcorpBrandGrad" x1="0" y1="0" x2="1" y2="1">
                <stop offset="0" stop-color="#6366f1"/>
                <stop offset="1" stop-color="#4338ca"/>
            </linearGradient>
        </defs>
        <rect width="64" height="64" rx="15" fill="url(#cvcorpBrandGrad)"/>
    ...
    <span style="font-size:17px;font-weight:800;letter-spacing:-0.03em;line-height:1;"
          class="text-gray-950 dark:text-white">CV<span style="color:#6366f1;">Corp</span></span>
</span>
